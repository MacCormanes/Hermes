  ...
  return (
    <div className='bg-gradient-to-b from-slate-100 to-slate-200 flex h-100'>
      <section className='w-1/2 flex flex-col justify-center px-12'>
        <h1 className='text-5xl tracking-widest font-extrabold mb-3 bg-gradient-to-tl from-stone-400 to-stone-700 bg-clip-text text-transparent'>Your style,</h1>
        <h1 className='text-5xl tracking-wide font-extrabold mb-5 bg-gradient-to-tl from-stone-400 to-stone-700 bg-clip-text text-transparent'>Your personality,</h1>
