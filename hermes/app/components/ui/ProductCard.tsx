  ...
  return (
    <div className="mb-5 font-montserrat">
      ...
      <div className="flex gap-1 mt-2">
        ...
        <Button onClick={handleClick} className="w-1/3 py-2 text-xs text-orange-900 transition-all duration-500 bg-orange-200 border border-orange-900 whitespace-nowrap hover:scale-105 hover:bg-orange-300">
          Add to cart
        </Button>
      </div>
    </div>
