  ...
  return (
    <div className="grid grid-cols-3 grid-row-3 gap-x-1 h-[670px] overflow-hidden scroll-smooth hover:overflow-scroll no-scrollbar">
      <div className="flex flex-col justify-center gap-y-6">
        <div className="relative h-64 shadow-md w-44 rounded-3xl shadow-slate-300/70">
          <Image
      ...
      <div className="flex flex-col justify-center my-5">
        <div className="relative h-64 mb-6 shadow-md w-44 gap-y-5 rounded-3xl shadow-slate-300/70">
          <Image
        ...
        <div className="relative h-64 shadow-md w-44 gap-y-5 rounded-3xl shadow-slate-300/70">
          <Image
