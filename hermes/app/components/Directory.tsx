      ...
      <AnimationOnScroll>
        <div className="flex items-baseline justify-between text-stone-800">
          ...
          <div className="transition-all duration-500 text-orange-950 hover:text-orange-500">
            <Link href="" className="">
              <p className="hidden text-right sm:inline">Browse all categories </p>
              <Image
        ...
        <div className="relative grid-flow-col grid-rows-6 gap-4 grid-col-8 md:grid lg:h-[700px]">
          <div className="relative col-span-4 row-span-6 shadow-md card-container-transition min-h-[250px] shadow-black/50 mb-5">
            <Image
          ...
          <div className="relative col-span-4 row-span-3 shadow-md card-container-transition shadow-black/50 min-h-[150px] mb-5">
            <Image
