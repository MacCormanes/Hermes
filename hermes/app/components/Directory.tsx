  ...
  return (
    <div className="bg-gradient-to-tl from-orange-200 to-orange-100 px-12 py-[60px]">
      <AnimationOnScroll>
        ...
        <div className="relative grid-flow-col grid-rows-6 gap-4 grid-col-8 md:grid lg:h-[700px]">
          <Link href="/shop" className="relative col-span-4 row-span-6 shadow-md card-container-transition min-h-[250px] shadow-black/50 mb-5">
              <Image
          ...
          <Link href="/shop/womens" className="relative col-span-4 row-span-3 shadow-md card-container-transition shadow-black/50 min-h-[150px] mb-5">
            <Image
          ...
          <Link href='/shop/mens' className="relative col-span-4 row-span-3 shadow-md card-container-transition shadow-black/50 min-h-[150px] mb-5">
            <Image
